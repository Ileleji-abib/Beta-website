        ...
        <div className="container">
          <div className="List-content">
            ...
            <div className="ind-listing">
              <div className="contentlist-details">
                ...
                <div className="list-item">
                  ...
                  <div className="list-item-writeup">
                    <h4>Build secure Apps</h4>
                    <p>High-performance mobile applications designed for Android and Ios ecosystems.</p>
                  </div>
                </div>
