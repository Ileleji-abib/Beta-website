        ...
        <section className="Price-list-section">
            <div className="container">
                <div className="price-list-content">
                    <section className="pricingintro-section">
                        

                        <div className="price-box">
                            <div className="feauture-header">
                    ...
                    <div className="price-list-grid">
                        <div className="price-list-grid-content">
                            ...
                            <div className="price-plan-card">
                                <div className="price-offer">
                                    <div className="top-info">
                                       <div className="trio"> <h4> Starter plan </h4> <span><p>Most Popular</p></span></div>
                                       <p className="price">$50</p>
                                        <p className="price-intro">Perfect for small teams, startups, and growing businesses</p>
                                    </div>


                                    <div className="p-hero-btn">
                                        <a href="" class="click-buttons  buid">Build With Us</a>
